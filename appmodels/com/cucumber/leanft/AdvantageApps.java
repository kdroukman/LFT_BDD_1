...
public class AdvantageApps extends AppModelBase {		private AdvantageApplication AdvantageApplication;
	
	public AdvantageApps(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("AdvantageApps");
	...
	private MenuUiObject MenuUiObject;
	...
	private SavingsBalanceLabel SavingsBalanceLabel;
	private CheckingBalanceLabel CheckingBalanceLabel;
		...
		MenuUiObject = new MenuUiObject(this, applicationModel);
		...
		SavingsBalanceLabel = new SavingsBalanceLabel(this, applicationModel);
		CheckingBalanceLabel = new CheckingBalanceLabel(this, applicationModel);
		...
		protected com.hp.lft.sdk.mobile.ApplicationDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.mobile.ApplicationDescription.Builder().identifier("com.hpswdemo.advantageinc").name("Advantage").packaged(false).build();
			}catch(Exception e){
		...
		public MenuUiObject MenuUiObject() { return MenuUiObject; }
		...
		public SavingsBalanceLabel SavingsBalanceLabel() { return SavingsBalanceLabel; }
		public CheckingBalanceLabel CheckingBalanceLabel() { return CheckingBalanceLabel; }
			...
			public class UsernameEditField extends EditFieldNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.EditFieldDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.mobile.EditFieldDescription.Builder().className("Input").resourceId("com.hpswdemo.advantageinc:id/loginUserNameEditText").mobileCenterIndex(0).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class PasswordEditField extends EditFieldNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.EditFieldDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.EditFieldDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.EditFieldDescription.Builder().className("Input").resourceId("com.hpswdemo.advantageinc:id/loginPasswordEditText").mobileCenterIndex(1).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class LoginButton extends ButtonNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.ButtonDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.mobile.ButtonDescription.Builder().text("LOGIN").className("Button").resourceId("com.hpswdemo.advantageinc:id/loginButton").mobileCenterIndex(0).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class MenuUiObject extends UiObjectNodeBase
	{

		
								public MenuUiObject(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.mobile.UiObjectDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.mobile.UiObjectDescription.Builder().className("ImageView").resourceId("android:id/up").mobileCenterIndex(13).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class MoneyTransferLabel extends LabelNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.LabelDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.mobile.LabelDescription.Builder().text("MONEY TRANSFER").className("Label").resourceId("com.hpswdemo.advantageinc:id/menuItemTextView").mobileCenterIndex(23).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class TransferSumEditField extends EditFieldNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.EditFieldDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.EditFieldDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.EditFieldDescription.Builder().className("Input").resourceId("com.hpswdemo.advantageinc:id/transferSumEditText").mobileCenterIndex(0).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class TRANSFERButton extends ButtonNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.ButtonDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.ButtonDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.ButtonDescription.Builder().text("TRANSFER").className("Button").resourceId("com.hpswdemo.advantageinc:id/transferButton").mobileCenterIndex(0).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class SavingsBalanceLabel extends LabelNodeBase
	{

		
								public SavingsBalanceLabel(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("SavingsBalance");
		}
		...
		protected com.hp.lft.sdk.mobile.LabelDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.LabelDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.LabelDescription.Builder().className("Label").resourceId("com.hpswdemo.advantageinc:id/accountBalanceTextView").mobileCenterIndex(3).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class CheckingBalanceLabel extends LabelNodeBase
	{

		
								public CheckingBalanceLabel(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("CheckingBalance");
		}
		...
		protected com.hp.lft.sdk.mobile.LabelDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.LabelDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.LabelDescription.Builder().className("Label").resourceId("com.hpswdemo.advantageinc:id/accountBalanceTextView").mobileCenterIndex(7).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;

...
public class AOBWeb extends AppModelBase {		private AosPage AosPage;
	
	public AOBWeb(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("AOBWeb");
				AosPage = new AosPage(contextTestObject, this);
		rebuildDescriptions();
	}	

			public AosPage AosPage() { return AosPage; }

		public class AosPage extends PageNodeBase
	{

		
			private ContactUsSubject ContactUsSubject;
	private SelectProductCombo SelectProductCombo;
	private SelectSubProduct SelectSubProduct;
	private EmailField EmailField;
	private SendButton SendButton;
						public AosPage(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

					ContactUsSubject = new ContactUsSubject(this, applicationModel);
		SelectProductCombo = new SelectProductCombo(this, applicationModel);
		SelectSubProduct = new SelectSubProduct(this, applicationModel);
		EmailField = new EmailField(this, applicationModel);
		SendButton = new SendButton(this, applicationModel);

			setDisplayName("aos page");
		}
		...
		protected com.hp.lft.sdk.web.PageDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.PageDescription.Builder().title(" Advantage Shopping").build();
			}catch(Exception e){
		...
		public SelectProductCombo SelectProductCombo() { return SelectProductCombo; }
		public SelectSubProduct SelectSubProduct() { return SelectSubProduct; }
		public EmailField EmailField() { return EmailField; }
			...
			public class ContactUsSubject extends EditFieldNodeBase
	{
								...
								public ContactUsSubject(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			...
			setDisplayName("ContactUsSubject");
		}
		...
		protected com.hp.lft.sdk.web.EditFieldDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.EditFieldDescription.Builder().name("WebEdit").type("textarea").tagName("TEXTAREA").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class SelectProductCombo extends ListBoxNodeBase
	{

		
								public SelectProductCombo(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("Select Product");
		}
		...
		protected com.hp.lft.sdk.web.ListBoxDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.ListBoxDescription.Builder().innerText(new RegExpProperty(".*Headphones.*")).tagName("SELECT").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class SelectSubProduct extends ListBoxNodeBase
	{

		
								public SelectSubProduct(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("Select SubProduct");
		}
		...
		protected com.hp.lft.sdk.web.ListBoxDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.ListBoxDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.ListBoxDescription.Builder().tagName("SELECT").vri(new VisualRelation().setTestObject(getRelatedObject("AosPage.SelectProductCombo")).setVerticalRelation(com.hp.lft.sdk.VerticalVisualRelation.ABOVE))
.build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
	...
	public class EmailField extends WebElementNodeBase
	{

		
								public EmailField(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("Email Field");
		}
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().tagName("LABEL").innerText("Email").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class SendButton extends WebElementNodeBase
	{
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.WebElementDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().innerText("SEND").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
